...
import 'package:firebase_crud/app/screens/view.dart';
...
class MyHomePage extends StatefulWidget {
  ...
  MyHomePage(
      {Key? key, this.title, Function(Brightness brightness)? changeTheme})
      : super(key: key) {
        ...
        child: AnimatedContainer(
          ...
          child: ListView(
            ...
            children: <Widget>[
              ...
              GestureDetector(
                  onTap: gotoEditNote, child: const AddNoteCardComponent()),
      ...
      for (var note in notesList) {
        if (note.title!
          ...
          noteComponentsList.add(NoteCardComponent(
            noteData: note,
            onTapAction: (noteModel) {
              openNoteToRead(noteModel!);
            },
          ));
        }
      }
